...
- **License:** GPL-3.0
- **Upstream repository:** https://github.com/eprints/eprints3.4
- **Canonical source repository:** https://github.com/eprints/eprints3.4
- **Official documentation:** https://wiki.eprints.org/w/Installation
- **Homepage:** https://www.eprints.org/
...
Service aliases: `apache2, httpd, mysql, mariadb, eprints`
...
- The official wiki distinguishes Debian/Ubuntu and RHEL/Fedora/CentOS installation paths; source Git is the production recommendation.
