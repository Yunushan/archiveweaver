...
- **License:** GPL-2.0
- **Upstream repository:** https://github.com/sismics/docs
- **Canonical source repository:** https://github.com/sismics/docs
- **Official documentation:** https://teedy.io/en/
- **Homepage:** https://teedy.io/
- **Default HTTP port:** 8080
- **Container image hint:** `sismics/teedy`
...
Service aliases: `teedy, jetty, tomcat`
...
- Teedy was formerly known as Sismics Docs; pin the source/release identity and avoid community images unless explicitly approved.
