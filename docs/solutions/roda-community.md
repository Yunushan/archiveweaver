...
- **License:** LGPL-3.0
- **Upstream repository:** https://github.com/keeps/roda
- **Canonical source repository:** https://github.com/keeps/roda
- **Official documentation:** https://www.roda-community.org/documentation/
- **Homepage:** https://www.roda-community.org/
...
Service aliases: `roda, tomcat, solr`
...
- The upstream local installation guide is single-node and testing-oriented; design production storage and database separately.
