...
- **Upstream repository:** https://github.com/DSpace/DSpace
- **Canonical source repository:** https://github.com/DSpace/DSpace
- **Official documentation:** https://wiki.lyrasis.org/display/DSDOC10x/Installing+DSpace
- **Homepage:** https://dspace.org/
...
Service aliases: `dspace, tomcat, solr`

HTTP paths: `/server/api, /home`
