...
- **Category:** repository-backend
- **License:** Apache-2.0
- **Upstream repository:** https://github.com/fcrepo/fcrepo
- **Canonical source repository:** https://github.com/fcrepo/fcrepo
- **Official documentation:** https://wiki.lyrasis.org/display/FEDORA6x/Installation+and+Configuration
- **Homepage:** https://fedorarepository.org/
...
Service aliases: `fedora, tomcat, java`
...
- Fedora is a repository backend, not a complete public UI; pair it with a client such as Islandora or Hyrax.
