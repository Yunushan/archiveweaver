...
- **License:** GPL-3.0
- **Upstream repository:** https://github.com/collectiveaccess/providence
- **Canonical source repository:** https://github.com/collectiveaccess/providence
- **Official documentation:** https://docs.collectiveaccess.org/providence/user/setup/install/
- **Homepage:** https://collectiveaccess.org/
...
Service aliases: `apache2, httpd, nginx, mysql, mariadb`
...
- Providence is the cataloguing application; Pawtucket is the public web layer and should be versioned separately.
