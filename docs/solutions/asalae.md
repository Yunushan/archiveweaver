...
- **License:** AGPL-3.0
- **Upstream repository:** https://gitlab.adullact.net/Libriciel/archivage/asalae
- **Canonical source repository:** https://gitlab.adullact.net/Libriciel/archivage/asalae
- **Official documentation:** https://www.asalae.fr/
- **Homepage:** https://www.asalae.fr/
...
Service aliases: `asalae, apache2, nginx, postgresql`
...
- The official source and Compose assets are hosted on the ADULLACT GitLab instance.
