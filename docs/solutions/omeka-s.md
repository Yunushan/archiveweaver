...
- **License:** GPL-3.0
- **Upstream repository:** https://github.com/omeka/omeka-s
- **Canonical source repository:** https://github.com/omeka/omeka-s
- **Official documentation:** https://omeka.org/s/docs/user-manual/install/
...
- Omeka S is intentionally extensible through modules; check module compatibility as part of the release manifest.
