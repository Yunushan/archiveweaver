...
- **License:** LGPL-3.0
- **Upstream repository:** https://github.com/logicaldoc/community
- **Canonical source repository:** https://github.com/logicaldoc/community
- **Official documentation:** https://www.logicaldoc.com/download-logicaldoc-community
- **Homepage:** https://www.logicaldoc.com/
- **Default HTTP port:** 8080
- **Container image hint:** `logicaldoc/logicaldoc-ce`
...
Service aliases: `logicaldoc, tomcat, mysql, mariadb`
...
- The project publishes separate Community and Docker repositories; do not use embedded HSQLDB for production.
