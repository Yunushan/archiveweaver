...
- **License:** GPL-3.0
- **Upstream repository:** https://labs.maarch.org/maarch/MaarchCourrier
- **Canonical source repository:** https://labs.maarch.org/maarch/MaarchCourrier
- **Official documentation:** https://docs.maarch.org/
- **Homepage:** https://maarch.com/maarch-courrier/
- **Default HTTP port:** 80
- **Container image hint:** `maarch/maarchcourrier`
...
- Use the official Maarch Labs source and the current Maarch documentation; older GitHub mirrors are not authoritative.
