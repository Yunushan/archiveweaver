...
- **Category:** electronic-records-management
- **License:** GPL-3.0
- **Upstream repository:** https://labs.maarch.org/maarch/maarchRM
- **Canonical source repository:** https://labs.maarch.org/maarch/maarchRM
- **Official documentation:** https://docs.maarch.org/gitbook/html/maarchRM/
- **Homepage:** https://maarch.com/maarch-rm/
- **Default HTTP port:** 80
- **Container image hint:** `maarch/maarchrm`
...
Service aliases: `apache2, httpd, postgresql`
...
- The official project is hosted on Maarch Labs rather than GitHub; use the linked documentation and image registry.
