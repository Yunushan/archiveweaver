...
- **License:** AGPL-3.0
- **Upstream repository:** https://github.com/artefactual/archivematica
- **Canonical source repository:** https://github.com/artefactual/archivematica
- **Official documentation:** https://www.archivematica.org/en/docs/archivematica-latest/admin-manual/installation-setup/
...
Service aliases: `archivematica, archivematica-storage-service, nginx`
...
- Preservation workflows are multi-service; a single container health check is not enough.
