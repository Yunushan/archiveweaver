...
- **License:** Apache-2.0
- **Upstream repository:** https://github.com/IQSS/dataverse
- **Canonical source repository:** https://github.com/IQSS/dataverse
- **Official documentation:** https://guides.dataverse.org/en/latest/installation/
...
Service aliases: `dataverse, payara, solr`

HTTP paths: `/api/info/version`
