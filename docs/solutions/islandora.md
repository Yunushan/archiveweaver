...
- **License:** GPL-3.0
- **Upstream repository:** https://github.com/Islandora/islandora
- **Canonical source repository:** https://github.com/Islandora/islandora
- **Official documentation:** https://islandora.github.io/documentation/installation/
- **Homepage:** https://islandora.ca/
...
Service aliases: `apache2, httpd, nginx, fedora, solr`
...
- Islandora is a framework/distribution; deployment must choose a Drupal/Fedora composition such as the official documentation path.
