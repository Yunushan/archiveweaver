...
- **License:** AGPL-3.0
- **Upstream repository:** https://github.com/artefactual/atom
- **Canonical source repository:** https://github.com/artefactual/atom
- **Official documentation:** https://www.accesstomemory.org/docs/
- **Homepage:** https://www.accesstomemory.org/
- **Default HTTP port:** 80
- **Container image hint:** `artefactual/atom`
...
Service aliases: `apache2, httpd, nginx, elasticsearch, mysql, mariadb`
...
- AtoM has official tarball, source, and Docker guidance; Elasticsearch compatibility must follow the selected AtoM release.
