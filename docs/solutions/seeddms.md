...
- **License:** GPL-2.0
- **Upstream repository:** https://sourceforge.net/projects/seeddms/
- **Canonical source repository:** https://sourceforge.net/projects/seeddms/
- **Official documentation:** https://www.seeddms.org/
...
- The official download channel is SourceForge; GitHub mirrors are not treated as authoritative.
