...
- **License:** Apache-2.0
- **Upstream repository:** https://github.com/papermerge/papermerge-core
- **Canonical source repository:** https://github.com/papermerge/papermerge-core
- **Official documentation:** https://docs.papermerge.io/
- **Homepage:** https://papermerge.com/
- **Default HTTP port:** 80
- **Container image hint:** `papermerge/papermerge`
...
Service aliases: `papermerge, celery, redis, postgresql`
