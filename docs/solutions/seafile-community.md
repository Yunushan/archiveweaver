...
- **License:** AGPL-3.0
- **Upstream repository:** https://github.com/haiwen/seafile
- **Canonical source repository:** https://github.com/haiwen/seafile
...
| --- | --- | --- | --- | --- | --- |
| Raw / native installation | conditional | supported | conditional | conditional | conditional |
...
Service aliases: `seafile, seahub, nginx, mariadb, memcached`
...
- Current Community deployment guidance is container-first; verify the selected release's Community/Professional boundaries before applying HA automation.
