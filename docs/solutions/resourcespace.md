...
- **Upstream repository:** https://github.com/resourcespace/resourcespace
- **Canonical source repository:** https://github.com/resourcespace/resourcespace
- **Official documentation:** https://www.resourcespace.com/knowledge-base/systemadmin/install_overview
- **Homepage:** https://www.resourcespace.com/
- **Default HTTP port:** 80
- **Container image hint:** `resourcespace/resourcespace`
...
- FFmpeg
- file storage
- optional search/preview services
...
Service aliases: `apache2, httpd, nginx, mariadb, mysql`
...
- Large media uploads require deliberate PHP, web-server, reverse-proxy, and filesystem limits.
